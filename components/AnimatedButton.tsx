...
export default function AnimatedButton({ children }: { children: ReactNode }) {
    ...
    return (
        <button
            className="group relative my-8 w-full rounded-full bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-40% to-purple-500/30 p-1 text-white transition-transform hover:scale-110 active:scale-105"
