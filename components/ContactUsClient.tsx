  ...
  if (showAppointment) {
    return (
      <div className="max-w-3xl relative mx-auto">
        ...
        <div className='max-w-3xl rounded-[38px] bg-[#16202a] mx-auto border-2 w-full h-auto mt-2 z-30 absolute top-10 left-0 right-0' >
          <h2 className='text-center text-white py-10 text-5xl' >Schedule Booking</h2>
          <div className="flex flex-col gap-y-4 items-center w-full">
            <div className="w-full">
              <Label htmlFor="email" className="text-white w-full mb-4 text-xl max-w-xl mx-auto px-28">Your Name <span className="text-red-500" >*</span></Label>
              <Input className="mt-4 rounded-full max-w-xl mx-auto pl-6 py-6" placeholder="Name" />
            </div>
            <div className="w-full">
              <Label htmlFor="email" className="text-white w-full mb-4 text-xl max-w-xl mx-auto px-28">Phone Number <span className="text-red-500" >*</span></Label>
              <Input className="mt-4 rounded-full max-w-xl mx-auto pl-6 py-6" placeholder="Phone Number" type="number" />
            </div>
            <div className="w-full">
              <Label htmlFor="email" className="text-white w-full mb-4 text-xl max-w-xl mx-auto px-28">Your Address <span className="text-red-500" >*</span></Label>
              <Input className="mt-4 rounded-full max-w-xl mx-auto pl-6 py-6" placeholder="Address" type="text" />
            </div>
            <div className="w-full">
              <Label htmlFor="email" className="text-white w-full mb-4 py-6 text-xl max-w-xl mx-auto px-28">
