...
const ContactUs = () => {
  ...
  return (
    <div>
      <div className='bg-[#e6f0fe] min-h-screen h-auto pb-10 z-0'>
          ...
          <div className='lg:col-span-5 xl:col-span-3 text-gray-500 text-lg '>
            <div className='lg:grid lg:grid-cols-2 md:grid md:grid-cols-3 lg:col-span-1'>
              <div className='md:col-span-2 lg:col-span-1 sm:text-center md:text-left'>
                ...
                <p className='mt-10 md:max-w-[370px]'>Email, call, or complete the form to learn how <span className='font-bold text-black'>3U logistics</span> can solve your messaging problem</p>
                <div className='mt-7'>
